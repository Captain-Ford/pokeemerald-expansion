const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_CATERPIE]              = {{EVO_LEVEL, 5, SPECIES_METAPOD}},
    [SPECIES_METAPOD]               = {{EVO_LEVEL, 10, SPECIES_BUTTERFREE}},
    [SPECIES_WEEDLE]                = {{EVO_LEVEL, 5, SPECIES_KAKUNA}},
    ...
    [SPECIES_ZUBAT]                 = {{EVO_LEVEL, 25, SPECIES_GOLBAT}},
    [SPECIES_GOLBAT]                = {{EVO_FRIENDSHIP, 0, SPECIES_CROBAT}},
    [SPECIES_ODDISH]                = {{EVO_LEVEL, 25, SPECIES_GLOOM}},
    [SPECIES_GLOOM]                 = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_VILEPLUME},
                                       {EVO_ITEM, ITEM_SUN_STONE, SPECIES_BELLOSSOM}},
    [SPECIES_PARAS]                 = {{EVO_LEVEL, 25, SPECIES_PARASECT}},
    ...
    [SPECIES_BELLSPROUT]            = {{EVO_LEVEL, 25, SPECIES_WEEPINBELL}},
    ...
    [SPECIES_SLOWPOKE]              = {{EVO_LEVEL, 35, SPECIES_SLOWBRO},
    ...
    [SPECIES_FLAAFFY]               = {{EVO_LEVEL, 35, SPECIES_AMPHAROS}},
    [SPECIES_MARILL]                = {{EVO_LEVEL, 20, SPECIES_AZUMARILL}},
    [SPECIES_HOPPIP]                = {{EVO_LEVEL, 20, SPECIES_SKIPLOOM}},
    [SPECIES_SKIPLOOM]              = {{EVO_LEVEL, 35, SPECIES_JUMPLUFF}},
    ...
    [SPECIES_PHANPY]                = {{EVO_LEVEL, 35, SPECIES_DONPHAN}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_WURMPLE]               = {{EVO_LEVEL_SILCOON, 5, SPECIES_SILCOON},
                                       {EVO_LEVEL_CASCOON, 5, SPECIES_CASCOON}},
    ...
    [SPECIES_TAILLOW]               = {{EVO_LEVEL, 25, SPECIES_SWELLOW}},
    [SPECIES_SHROOMISH]             = {{EVO_LEVEL, 25, SPECIES_BRELOOM}},
    ...
    [SPECIES_BALTOY]                = {{EVO_LEVEL, 35, SPECIES_CLAYDOL}},
#if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_TRAPINCH]              = {{EVO_LEVEL, 25, SPECIES_VIBRAVA}},
    [SPECIES_VIBRAVA]               = {{EVO_LEVEL, 45, SPECIES_FLYGON}},
    [SPECIES_MAKUHITA]              = {{EVO_LEVEL, 35, SPECIES_HARIYAMA}},
    ...
    [SPECIES_SEALEO]                = {{EVO_LEVEL, 45, SPECIES_WALREIN}},
    ...
    [SPECIES_WYNAUT]                = {{EVO_LEVEL, 20, SPECIES_WOBBUFFET}},
    ...
    [SPECIES_LOUDRED]               = {{EVO_LEVEL, 35, SPECIES_EXPLOUD}},
    ...
    [SPECIES_LAIRON]                = {{EVO_LEVEL, 45, SPECIES_AGGRON}},
    ...
    [SPECIES_KIRLIA]                = {{EVO_LEVEL, 35, SPECIES_GARDEVOIR},
                                    #if P_GEN_4_POKEMON == TRUE
    ...
    [SPECIES_GROTLE]                = {{EVO_LEVEL, 40, SPECIES_TORTERRA}},
    ...
    [SPECIES_STARLY]                = {{EVO_LEVEL, 15, SPECIES_STARAVIA}},
    [SPECIES_STARAVIA]              = {{EVO_LEVEL, 35, SPECIES_STARAPTOR}},
    ...
    [SPECIES_LUXIO]                 = {{EVO_LEVEL, 35, SPECIES_LUXRAY}},
    [SPECIES_BUDEW]                 = {{EVO_FRIENDSHIP_DAY, 0, SPECIES_ROSELIA}},
    [SPECIES_CRANIDOS]              = {{EVO_LEVEL, 35, SPECIES_RAMPARDOS}},
    [SPECIES_SHIELDON]              = {{EVO_LEVEL, 35, SPECIES_BASTIODON}},
    [SPECIES_BURMY]                 = {{EVO_LEVEL_FEMALE, 20, SPECIES_WORMADAM},
                                       {EVO_LEVEL_MALE, 20, SPECIES_MOTHIM}},
    [SPECIES_COMBEE]                = {{EVO_LEVEL_FEMALE, 25, SPECIES_VESPIQUEN}},
    [SPECIES_BUIZEL]                = {{EVO_LEVEL, 25, SPECIES_FLOATZEL}},
    ...
    [SPECIES_HIPPOPOTAS]            = {{EVO_LEVEL, 35, SPECIES_HIPPOWDON}},
    [SPECIES_SKORUPI]               = {{EVO_LEVEL, 35, SPECIES_DRAPION}},
    [SPECIES_CROAGUNK]              = {{EVO_LEVEL, 35, SPECIES_TOXICROAK}},
    ...
    [SPECIES_LILLIPUP]              = {{EVO_LEVEL, 15, SPECIES_HERDIER}},
    [SPECIES_HERDIER]               = {{EVO_LEVEL, 35, SPECIES_STOUTLAND}},
    ...
    [SPECIES_PIDOVE]                = {{EVO_LEVEL, 15, SPECIES_TRANQUILL}},
    [SPECIES_TRANQUILL]             = {{EVO_LEVEL, 35, SPECIES_UNFEZANT}},
    ...
    [SPECIES_PALPITOAD]             = {{EVO_LEVEL, 35, SPECIES_SEISMITOAD}},
    [SPECIES_SEWADDLE]              = {{EVO_LEVEL, 15, SPECIES_SWADLOON}},
    [SPECIES_SWADLOON]              = {{EVO_FRIENDSHIP, 0, SPECIES_LEAVANNY}},
    [SPECIES_VENIPEDE]              = {{EVO_LEVEL, 15, SPECIES_WHIRLIPEDE}},
    ...
    [SPECIES_SANDILE]               = {{EVO_LEVEL, 25, SPECIES_KROKOROK}},
    [SPECIES_KROKOROK]              = {{EVO_LEVEL, 40, SPECIES_KROOKODILE}},
    [SPECIES_DARUMAKA]              = {{EVO_LEVEL, 35, SPECIES_DARMANITAN}},
    [SPECIES_DWEBBLE]               = {{EVO_LEVEL, 30, SPECIES_CRUSTLE}},
    [SPECIES_SCRAGGY]               = {{EVO_LEVEL, 35, SPECIES_SCRAFTY}},
    [SPECIES_YAMASK]                = {{EVO_LEVEL, 35, SPECIES_COFAGRIGUS}},
    [SPECIES_TIRTOUGA]              = {{EVO_LEVEL, 35, SPECIES_CARRACOSTA}},
    [SPECIES_ARCHEN]                = {{EVO_LEVEL, 35, SPECIES_ARCHEOPS}},
    [SPECIES_TRUBBISH]              = {{EVO_LEVEL, 35, SPECIES_GARBODOR}},
    ...
    [SPECIES_GOTHITA]               = {{EVO_LEVEL, 25, SPECIES_GOTHORITA}},
    ...
    [SPECIES_DEERLING]              = {{EVO_LEVEL, 35, SPECIES_SAWSBUCK}},
    [SPECIES_KARRABLAST]            = {{EVO_TRADE_SPECIFIC_MON, SPECIES_SHELMET, SPECIES_ESCAVALIER},
                                       {EVO_ITEM, ITEM_METAL_COAT, SPECIES_ESCAVALIER}},   
    ...
    [SPECIES_FERROSEED]             = {{EVO_LEVEL, 35, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]                 = {{EVO_LEVEL, 25, SPECIES_KLANG}},
    ...
    [SPECIES_SCATTERBUG]            = {{EVO_LEVEL, 5, SPECIES_SPEWPA}},
    [SPECIES_SPEWPA]                = {{EVO_LEVEL, 10, SPECIES_VIVILLON}},
    [SPECIES_LITLEO]                = {{EVO_LEVEL, 35, SPECIES_PYROAR}},
    [SPECIES_FLABEBE]               = {{EVO_LEVEL, 20, SPECIES_FLOETTE}},
    [SPECIES_FLOETTE]               = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES}},
    [SPECIES_SKIDDO]                = {{EVO_LEVEL, 35, SPECIES_GOGOAT}},
    [SPECIES_PANCHAM]               = {{EVO_LEVEL_DARK_TYPE_MON_IN_PARTY, 35, SPECIES_PANGORO}},
    ...
    [SPECIES_BINACLE]               = {{EVO_LEVEL, 35, SPECIES_BARBARACLE}},
    ...
    [SPECIES_TYRUNT]                = {{EVO_LEVEL, 35, SPECIES_TYRANTRUM}},
    [SPECIES_AMAURA]                = {{EVO_LEVEL, 35, SPECIES_AURORUS}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_TRADE, 0, SPECIES_TREVENANT},
                                       {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_TREVENANT}},
    [SPECIES_PUMPKABOO]             = {{EVO_TRADE, 0, SPECIES_GOURGEIST},
                                       {EVO_ITEM, ITEM_DUSK_STONE, SPECIES_GOURGEIST}},
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 40, SPECIES_AVALUGG},
    ...
    [SPECIES_PIKIPEK]               = {{EVO_LEVEL, 15, SPECIES_TRUMBEAK}},
    [SPECIES_TRUMBEAK]              = {{EVO_LEVEL, 35, SPECIES_TOUCANNON}},
    ...
    [SPECIES_CUTIEFLY]              = {{EVO_LEVEL, 20, SPECIES_RIBOMBEE}},
    ...
    [SPECIES_MAREANIE]              = {{EVO_LEVEL, 35, SPECIES_TOXAPEX}},
    [SPECIES_MUDBRAY]               = {{EVO_LEVEL, 35, SPECIES_MUDSDALE}},
    [SPECIES_DEWPIDER]              = {{EVO_LEVEL, 25, SPECIES_ARAQUANID}},
    [SPECIES_FOMANTIS]              = {{EVO_LEVEL_DAY, 25, SPECIES_LURANTIS}},
    [SPECIES_MORELULL]              = {{EVO_LEVEL, 25, SPECIES_SHIINOTIC}},
    [SPECIES_SALANDIT]              = {{EVO_LEVEL_FEMALE, 35, SPECIES_SALAZZLE}},
    [SPECIES_STUFFUL]               = {{EVO_LEVEL, 40, SPECIES_BEWEAR}},
    ...
    [SPECIES_COSMOG]                = {{EVO_LEVEL, 30, SPECIES_COSMOEM}},
    [SPECIES_COSMOEM]               = {{EVO_LEVEL_DAY, 50, SPECIES_SOLGALEO},
                                       {EVO_LEVEL_NIGHT, 50, SPECIES_LUNALA}},
    [SPECIES_POIPOLE]               = {{EVO_MOVE, MOVE_DRAGON_PULSE, SPECIES_NAGANADEL}},
    [SPECIES_MELTAN]                = {{EVO_LEVEL, 50, SPECIES_MELMETAL}},
#endif
    ...
    [SPECIES_SKWOVET]               = {{EVO_LEVEL, 20, SPECIES_GREEDENT}},
    ...
    [SPECIES_NICKIT]                = {{EVO_LEVEL, 20, SPECIES_THIEVUL}},
    [SPECIES_GOSSIFLEUR]            = {{EVO_LEVEL, 25, SPECIES_ELDEGOSS}},
    [SPECIES_WOOLOO]                = {{EVO_LEVEL, 25, SPECIES_DUBWOOL}},
    [SPECIES_CHEWTLE]               = {{EVO_LEVEL, 35, SPECIES_DREDNAW}},
    [SPECIES_YAMPER]                = {{EVO_LEVEL, 25, SPECIES_BOLTUND}},
    [SPECIES_ROLYCOLY]              = {{EVO_LEVEL, 25, SPECIES_CARKOL}},
    ...
    [SPECIES_SILICOBRA]             = {{EVO_LEVEL, 35, SPECIES_SANDACONDA}},
    [SPECIES_ARROKUDA]              = {{EVO_LEVEL, 30, SPECIES_BARRASKEWDA}},
    [SPECIES_TOXEL]                 = {{EVO_LEVEL_NATURE_AMPED, 35, SPECIES_TOXTRICITY},
                                       {EVO_LEVEL_NATURE_LOW_KEY, 35, SPECIES_TOXTRICITY_LOW_KEY}},
    [SPECIES_SIZZLIPEDE]            = {{EVO_LEVEL, 35, SPECIES_CENTISKORCH}},
    [SPECIES_CLOBBOPUS]             = {{EVO_MOVE, MOVE_TAUNT, SPECIES_GRAPPLOCT}},
    [SPECIES_SINISTEA]              = {{EVO_ITEM, ITEM_CRACKED_POT, SPECIES_POLTEAGEIST}},
    [SPECIES_HATENNA]               = {{EVO_LEVEL, 25, SPECIES_HATTREM}},
    [SPECIES_HATTREM]               = {{EVO_LEVEL, 40, SPECIES_HATTERENE}},
    [SPECIES_IMPIDIMP]              = {{EVO_LEVEL, 25, SPECIES_MORGREM}},
    ...
    [SPECIES_CUFANT]                = {{EVO_LEVEL, 40, SPECIES_COPPERAJAH}},
