...
static const struct TrainerMon sParty_Matt[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_HAMMER_ARM, MOVE_CRABHAMMER, MOVE_ICE_HAMMER}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 43,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRABHAMMER, MOVE_NIGHT_SLASH, MOVE_SWORDS_DANCE, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_STORM_THROW, MOVE_ICE_PUNCH, MOVE_LIQUIDATION, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CROSS_CHOP, MOVE_LIQUIDATION, MOVE_STONE_EDGE, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 45,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_X_SCISSOR, MOVE_AQUA_JET, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_ShellySeafloorCavern[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC_SPIKES, MOVE_EXPLOSION, MOVE_HYDRO_PUMP, MOVE_ICE_SHARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 48,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WAVE_CRASH, MOVE_DRILL_PECK, MOVE_DRILL_RUN, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 49,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPNOSIS, MOVE_FOCUS_BLAST, MOVE_DARK_PULSE, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(15, 15, 15, 15, 15, 15),
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BANEFUL_BUNKER, MOVE_VENOSHOCK, MOVE_WATER_PULSE, MOVE_RECOVER}
    }
};
...
static const struct TrainerMon sParty_Archie[] = {
    ...
    .moves = {MOVE_WAVE_CRASH, MOVE_CRUNCH, MOVE_POISON_FANG, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 50,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ANCHOR_SHOT, MOVE_POWER_WHIP, MOVE_PHANTOM_FORCE, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LIQUIDATION, MOVE_ICICLE_CRASH, MOVE_EARTHQUAKE, MOVE_SLACK_OFF}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 51,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_GIGA_DRAIN, MOVE_FLAMETHROWER, MOVE_THUNDER, MOVE_HYDRO_PUMP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 52,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SACRED_SWORD, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_AQUA_JET}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 53,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_WAVE_CRASH, MOVE_DRAGON_RUSH, MOVE_THUNDER_FANG, MOVE_DRAGON_DANCE}
    }
};
...
static const struct TrainerMon sParty_Ricky2[] = {
    ...
    .lvl = 52,
    .species = SPECIES_SLOWBRO,
    .moves = {MOVE_SURF, MOVE_PSYCHIC, MOVE_SLACK_OFF, MOVE_AMNESIA}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_GASTRODON,
    .moves = {MOVE_MUD_BOMB, MOVE_MUDDY_WATER, MOVE_RECOVER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_PALOSSAND,
    .moves = {MOVE_SHORE_UP, MOVE_HYPNOSIS, MOVE_EARTH_POWER, MOVE_HEX}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_VANILLUXE,
    .moves = {MOVE_BLIZZARD, MOVE_WATER_PULSE, MOVE_ACID_ARMOR, MOVE_RECOVER}
    }
};
...
static const struct TrainerMon sParty_Steve2[] = {
    ...
    .moves = {MOVE_HEAVY_SLAM, MOVE_EARTHQUAKE, MOVE_HEAD_SMASH, MOVE_IRON_DEFENSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 53,
    .species = SPECIES_RHYPERIOR,
    .moves = {MOVE_EARTHQUAKE, MOVE_ROCK_WRECKER, MOVE_MEGAHORN, MOVE_HAMMER_ARM}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 53,
    .species = SPECIES_TYRANITAR,
    .moves = {MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Walter2[] = {
    ...
    .lvl = 52,
    .species = SPECIES_STOUTLAND,
    .moves = {MOVE_GIGA_IMPACT, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_THUNDER_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_POLTEAGEIST,
    .moves = {MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN, MOVE_HYPNOSIS, MOVE_SHELL_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_PYROAR,
    .moves = {MOVE_HYPER_BEAM, MOVE_FIRE_BLAST, MOVE_EARTH_POWER, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_AEGISLASH,
    .moves = {MOVE_KINGS_SHIELD, MOVE_SWORDS_DANCE, MOVE_SHADOW_SNEAK, MOVE_SACRED_SWORD}
    }
};
...
static const struct TrainerMon sParty_Sidney[] = {
    ...
    .moves = {MOVE_NIGHT_SLASH, MOVE_PLAY_ROUGH, MOVE_ICE_BEAM, MOVE_STONE_EDGE}
    }
};
...
static const struct TrainerMon sParty_Phoebe[] = {
    ...
    .moves = {MOVE_LEECH_SEED, MOVE_WILL_O_WISP, MOVE_GIGA_DRAIN, MOVE_SHADOW_SNEAK}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 59,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_SCALD, MOVE_HEX, MOVE_WILL_O_WISP, MOVE_ICE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 60,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_FOCUS_BLAST, MOVE_HYPNOSIS, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 59,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_MOONBLAST, MOVE_NASTY_PLOT, MOVE_CONFUSE_RAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 60,
    ...
    .moves = {MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_MYSTICAL_FIRE, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    ...
    .moves = {MOVE_SHADOW_SNEAK, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH, MOVE_DRAIN_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLIZZARD, MOVE_FREEZE_DRY, MOVE_CONFUSE_RAY, MOVE_AURORA_VEIL}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 61,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_ICY_WIND, MOVE_AURORA_VEIL, MOVE_FREEZE_DRY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 62,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BLIZZARD, MOVE_WOOD_HAMMER, MOVE_HAMMER_ARM, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 62,
    ...
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ICICLE_CRASH, MOVE_SURF, MOVE_BLIZZARD, MOVE_SHEER_COLD}
    }
};
...
static const struct TrainerMon sParty_Drake[] = {
    ...
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WAVE_CRASH, MOVE_DRAGON_DANCE, MOVE_DRAGON_RUSH, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 64,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_DRAGON_RUSH, MOVE_SWORDS_DANCE, MOVE_STONE_EDGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 63,
    .species = SPECIES_DRAGALGE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SLUDGE_WAVE, MOVE_ACID_SPRAY, MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 63,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DARK_PULSE, MOVE_DRAGON_PULSE, MOVE_THUNDER, MOVE_FOCUS_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_OUTRAGE, MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE, MOVE_AERIAL_ACE}
    }
};
...
static const struct TrainerMon sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_SAND_TOMB, MOVE_ROCK_POLISH, MOVE_SANDSTORM}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 15,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ROCK_TOMB, MOVE_SPARK, MOVE_BLOCK, MOVE_BULLDOZE}
    }
};
...
static const struct TrainerMon sParty_Brawly1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FORCE_PALM, MOVE_VACUUM_WAVE, MOVE_COUNTER, MOVE_BULLET_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 19,
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_POWER_UP_PUNCH, MOVE_KNOCK_OFF, MOVE_MACH_PUNCH, MOVE_BULK_UP}
    }
};
...
static const struct TrainerMon sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BULLDOZE, MOVE_SHOCK_WAVE, MOVE_QUICK_ATTACK, MOVE_THUNDER_WAVE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 24,
    .species = SPECIES_EELEKTRIK,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ACID_SPRAY, MOVE_CHARGE_BEAM, MOVE_WATER_PULSE, MOVE_THUNDER_WAVE}
    },
    {
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_BRICK_BREAK, MOVE_ICE_PUNCH, MOVE_THUNDER_WAVE}
    }
};
...
static const struct TrainerMon sParty_Flannery1[] = {
    ...
    .species = SPECIES_DARUMAKA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_TAKE_DOWN, MOVE_OVERHEAT, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 30,
    ...
    .moves = {MOVE_MYSTICAL_FIRE, MOVE_DAZZLING_GLEAM, MOVE_ENERGY_BALL, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 31,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE, MOVE_SUNNY_DAY}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 31,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_ATTRACT, MOVE_ACID_SPRAY, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 33,
    ...
    .moves = {MOVE_OVERHEAT, MOVE_AURA_SPHERE, MOVE_SUNNY_DAY, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMon sParty_Norman1[] = {
    ...
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_ICE_BEAM, MOVE_THUNDERBOLT}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 34,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_HYPER_VOICE, MOVE_SLACK_OFF, MOVE_CALM_MIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 34,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SLACK_OFF, MOVE_BODY_SLAM, MOVE_SHADOW_PUNCH, MOVE_HAMMER_ARM}
    }
};
...
static const struct TrainerMon sParty_Winona1[] = {
    ...
    .species = SPECIES_SWANNA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ICY_WIND, MOVE_FEATHER_DANCE, MOVE_AIR_SLASH, MOVE_SURF}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 37,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_U_TURN, MOVE_AERIAL_ACE, MOVE_FLARE_BLITZ, MOVE_QUICK_ATTACK}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 38,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_DARK_PULSE, MOVE_PROTECT, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(26, 26, 26, 26, 26, 26),
    .lvl = 38,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AERIAL_ACE, MOVE_REVENGE, MOVE_ROCK_SLIDE, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 40,
...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .species = SPECIES_BRONZONG,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYSHOCK, MOVE_FLASH_CANNON, MOVE_SAFEGUARD, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    .species = SPECIES_MUSHARNA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MOONBLAST, MOVE_HYPNOSIS, MOVE_DREAM_EATER, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 48,
    .species = SPECIES_BEHEEYEM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SIGNAL_BEAM, MOVE_PSYSHOCK, MOVE_CHARGE_BEAM, MOVE_PSYCHIC_TERRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DARK_PULSE, MOVE_PSYCHIC_TERRAIN, MOVE_PSYSHOCK, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 50,
...
static const struct TrainerMon sParty_Juan1[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_WATER_PULSE, MOVE_GIGA_DRAIN, MOVE_ICE_BEAM, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 51,
    ...
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_WATER_PULSE, MOVE_THUNDER, MOVE_ICE_BEAM, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 53,
    .species = SPECIES_JELLICENT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HEX, MOVE_WILL_O_WISP, MOVE_WATER_PULSE, MOVE_GIGA_DRAIN}
    },
    {
    .iv = TRAINER_PARTY_IVS(24, 24, 24, 24, 24, 24),
    .lvl = 53,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_DAZZLING_GLEAM, MOVE_ICE_BEAM, MOVE_TOXIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 55,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYDRO_PUMP, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_HURRICANE}
    }
};
...
static const struct TrainerMon sParty_Isabel2[] = {
    ...
    .lvl = 52,
    .species = SPECIES_CINCCINO,
    .moves = {MOVE_TAIL_SLAP, MOVE_BULLET_SEED, MOVE_ROCK_BLAST, MOVE_SING}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_GRANBULL,
    .moves = {MOVE_PLAY_ROUGH, MOVE_CRUNCH, MOVE_CHARM, MOVE_FIRE_FANG}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_FURFROU,
    .moves = {MOVE_GIGA_IMPACT, MOVE_PLAY_ROUGH, MOVE_COTTON_GUARD, MOVE_SUCKER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(1, 1, 1, 1, 1, 1),
    .lvl = 52,
    .species = SPECIES_DELCATTY,
    .moves = {MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_ATTRACT, MOVE_SING}
    }
};
...
static const struct TrainerMon sParty_Timothy2[] = {
    ...
    .lvl = 53,
    .species = SPECIES_HARIYAMA,
    .moves = {MOVE_SUBMISSION, MOVE_KNOCK_OFF, MOVE_BULK_UP, MOVE_ICE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 53,
    .species = SPECIES_CONKELDURR,
    .moves = {MOVE_ROCK_SLIDE, MOVE_HAMMER_ARM, MOVE_BULK_UP, MOVE_EARTHQUAKE}
    },
    {
    .iv = TRAINER_PARTY_IVS(25, 25, 25, 25, 25, 25),
    .lvl = 53,
    .species = SPECIES_SAMUROTT,
    .moves = {MOVE_SACRED_SWORD, MOVE_RAZOR_SHELL, MOVE_NIGHT_SLASH, MOVE_AQUA_JET}
    }
};
...
static const struct TrainerMon sParty_StevenChampion[] = {
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_EARTHQUAKE, MOVE_STEALTH_ROCK, MOVE_ICE_FANG, MOVE_SANDSTORM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_BLIZZARD, MOVE_REFLECT, MOVE_METEOR_BEAM, MOVE_MIRROR_COAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    .species = SPECIES_AGGRON,
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_SUPERPOWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_CRUNCH, MOVE_FIRE_FANG, MOVE_THUNDER_FANG, MOVE_HEAD_SMASH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 67,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STEEL_WING, MOVE_BRAVE_BIRD, MOVE_ROOST, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 68,
...
static const struct TrainerMon sParty_Lao2[] = {
    ...
    .moves = {MOVE_CROSS_POISON, MOVE_CLOSE_COMBAT, MOVE_SUCKER_PUNCH, MOVE_VENOSHOCK}
    },
    {
    .lvl = 52,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_EXTREME_SPEED, MOVE_X_SCISSOR, MOVE_DOUBLE_TEAM, MOVE_AERIAL_ACE}
    },
    {
    .lvl = 52,
    .species = SPECIES_ACCELGOR,
    .moves = {MOVE_WATER_SHURIKEN, MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN}
    },
    {
    .lvl = 52,
    .species = SPECIES_GRENINJA,
    .moves = {MOVE_WATER_SHURIKEN, MOVE_DARK_PULSE, MOVE_ICE_BEAM, MOVE_VACUUM_WAVE}
    }
};
...
static const struct TrainerMon sParty_Madeline1[] = {
    ...
    .lvl = 24,
    .species = SPECIES_VULPIX,
    .moves = {MOVE_EMBER, MOVE_GROWL, MOVE_QUICK_ATTACK, MOVE_SUNNY_DAY}
    },
    {
    .lvl = 24,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_EMBER, MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_POWDER_SNOW}
    }
};
...
static const struct TrainerMon sParty_Angelica[] = {
    ...
    .lvl = 37,
    .species = SPECIES_CASTFORM,
    .moves = {MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_THUNDER, MOVE_HURRICANE}
    }
};
...
static const struct TrainerMon sParty_Kayley[] = {
    ...
    .moves = {MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_GROWTH, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .moves = {MOVE_AIR_SLASH, MOVE_THUNDER_WAVE, MOVE_DAZZLING_GLEAM, MOVE_ANCIENT_POWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 54,
    .species = SPECIES_ROSERADE,
    .moves = {MOVE_PETAL_DANCE, MOVE_GRASS_WHISTLE, MOVE_SLUDGE_BOMB, MOVE_PSYCHIC}
    },
    {
    .iv = TRAINER_PARTY_IVS(18, 18, 18, 18, 18, 18),
    .lvl = 54,
    .species = SPECIES_GOODRA,
    .moves = {MOVE_SLUDGE_WAVE, MOVE_MUDDY_WATER, MOVE_FOCUS_BLAST, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(30, 30, 30, 30, 30, 30),
    .lvl = 55,
    .species = SPECIES_GALLADE,
    .moves = {MOVE_SACRED_SWORD, MOVE_PSYCHO_CUT, MOVE_NIGHT_SLASH, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMon sParty_MaxieMagmaHideout[] = {
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_SUNNY_DAY, MOVE_DARK_PULSE, MOVE_FLAMETHROWER, MOVE_WILL_O_WISP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 42,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DRILL_RUN, MOVE_ROCK_SLIDE, MOVE_IRON_HEAD, MOVE_SWORDS_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_GLISCOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_AERIAL_ACE, MOVE_TOXIC, MOVE_ROOST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 43,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LAVA_PLUME, MOVE_EARTH_POWER, MOVE_STONE_EDGE, MOVE_ERUPTION}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 44,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_WOOD_HAMMER, MOVE_LEECH_SEED, MOVE_CURSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 45,
    .species = SPECIES_RHYPERIOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_WRECKER, MOVE_EARTHQUAKE, MOVE_HAMMER_ARM, MOVE_THUNDER_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Vivian[] = {
    ...
    .lvl = 22,
    .species = SPECIES_MEDITITE,
    .moves = {MOVE_MEDITATE, MOVE_DETECT, MOVE_CONFUSION, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(12, 12, 12, 12, 12, 12),
    .lvl = 22,
    .species = SPECIES_MIENFOO,
    .moves = {MOVE_THUNDER_PUNCH, MOVE_DETECT, MOVE_FORCE_PALM, MOVE_MEDITATE}
    }
};
...
static const struct TrainerMon sParty_Roxanne2[] = {
    ...
    .moves = {MOVE_ACROBATICS, MOVE_ROCK_SLIDE, MOVE_STEALTH_ROCK, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .moves = {MOVE_ROCK_WRECKER, MOVE_EARTHQUAKE, MOVE_COUNTER, MOVE_FIRE_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .moves = {MOVE_METEOR_BEAM, MOVE_CHARGE_BEAM, MOVE_SOLAR_BEAM, MOVE_FLASH_CANNON}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_ANCIENT_POWER, MOVE_PROTECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_STONE_EDGE, MOVE_SUPERPOWER, MOVE_X_SCISSOR, MOVE_RAZOR_SHELL}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_METEOR_BEAM, MOVE_DISCHARGE, MOVE_EARTH_POWER, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMon sParty_Brawly2[] = {
    ...
    .species = SPECIES_GRAPPLOCT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_STORM_THROW, MOVE_CIRCLE_THROW, MOVE_LIQUIDATION, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 57,
    ...
    .moves = {MOVE_ICE_HAMMER, MOVE_DRAIN_PUNCH, MOVE_EARTHQUAKE, MOVE_POWER_UP_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    ...
    .moves = {MOVE_SEED_BOMB, MOVE_SPORE, MOVE_FOCUS_PUNCH, MOVE_MACH_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .species = SPECIES_PANGORO,
    .heldItem = ITEM_MUSCLE_BAND,
    .moves = {MOVE_BRUTAL_SWING, MOVE_STONE_EDGE, MOVE_SUPERPOWER, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_AURA_SPHERE, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_BULLET_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    .species = SPECIES_MACHAMP,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_DYNAMIC_PUNCH, MOVE_POISON_JAB, MOVE_ICE_PUNCH, MOVE_SHADOW_PUNCH}
    }
};
...
static const struct TrainerMon sParty_Wattson2[] = {
    ...
    .species = SPECIES_ROTOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_VOLT_SWITCH, MOVE_LIGHT_SCREEN}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 58,
    .species = SPECIES_TOXTRICITY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BOOMBURST, MOVE_OVERDRIVE, MOVE_SLUDGE_BOMB, MOVE_DRAIN_PUNCH}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .species = SPECIES_VIKAVOLT,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_ZAP_CANNON, MOVE_ENERGY_BALL, MOVE_AGILITY, MOVE_BUG_BUZZ}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .species = SPECIES_EELEKTROSS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_CHARGE_BEAM, MOVE_ICE_BEAM, MOVE_HYDRO_PUMP, MOVE_FLAMETHROWER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    ...
    .heldItem = ITEM_WIDE_LENS,
    .moves = {MOVE_STEEL_BEAM, MOVE_ZAP_CANNON, MOVE_MIRROR_COAT, MOVE_CHARGE_BEAM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 62,
    ...
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_PLASMA_FISTS, MOVE_EARTHQUAKE, MOVE_ICE_PUNCH, MOVE_HAMMER_ARM}
    }
};
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_HEAT_ROCK,
    .moves = {MOVE_MYSTICAL_FIRE, MOVE_DAZZLING_GLEAM, MOVE_SUNNY_DAY, MOVE_CALM_MIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 59,
    .species = SPECIES_DARMANITAN,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_FLARE_BLITZ, MOVE_SUPERPOWER, MOVE_OVERHEAT, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    .species = SPECIES_SALAZZLE,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_ATTRACT, MOVE_SLUDGE_BOMB, MOVE_OVERHEAT, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    ...
    .heldItem = ITEM_CHARCOAL,
    .moves = {MOVE_GIGA_DRAIN, MOVE_SILVER_WIND, MOVE_FIERY_DANCE, MOVE_QUIVER_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_LAVA_PLUME, MOVE_STONE_EDGE, MOVE_OVERHEAT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 63,
    ...
    .heldItem = ITEM_POWER_HERB,
    .moves = {MOVE_SEARING_SHOT, MOVE_EARTH_POWER, MOVE_FOCUS_BLAST, MOVE_SOLAR_BEAM}
    }
};
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .species = SPECIES_BOUFFALANT,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_HEAD_CHARGE, MOVE_HEAD_SMASH, MOVE_FLAME_CHARGE, MOVE_WILD_CHARGE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 60,
    ...
    .moves = {MOVE_TAILWIND, MOVE_HURRICANE, MOVE_BOOMBURST, MOVE_OMINOUS_WIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 62,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_FIRE_BLAST, MOVE_THUNDER, MOVE_BLIZZARD, MOVE_BOOMBURST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 62,
    .species = SPECIES_BEWEAR,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_SUPERPOWER, MOVE_BRUTAL_SWING, MOVE_EARTHQUAKE, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 64,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_QUICK_CLAW,
    .moves = {MOVE_HAMMER_ARM, MOVE_BRUTAL_SWING, MOVE_GIGA_IMPACT, MOVE_SLACK_OFF}
    }
};
...
static const struct TrainerMon sParty_Winona2[] = {
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_DRILL_PECK, MOVE_STEEL_WING, MOVE_SPIKES, MOVE_TAILWIND}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 61,
    .species = SPECIES_SWANNA,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_TAILWIND, MOVE_HURRICANE, MOVE_HYDRO_PUMP, MOVE_BLIZZARD}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 62,
    .species = SPECIES_TOGEKISS,
    .heldItem = ITEM_EXPERT_BELT,
    .moves = {MOVE_DAZZLING_GLEAM, MOVE_AIR_SLASH, MOVE_ANCIENT_POWER, MOVE_FIRE_BLAST}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 63,
    .species = SPECIES_MANDIBUZZ,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_TOXIC, MOVE_ROOST, MOVE_ICY_WIND, MOVE_DARK_PULSE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 63,
    .species = SPECIES_BRAVIARY,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_CLOSE_COMBAT, MOVE_BRAVE_BIRD, MOVE_ROCK_SLIDE, MOVE_BULK_UP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SHELL_BELL,
    .moves = {MOVE_BRAVE_BIRD, MOVE_DRAGON_DANCE, MOVE_ROOST, MOVE_FIRE_BLAST}
    }
};
...
static const struct TrainerMon sParty_TateAndLiza2[] = {
    ...
    .species = SPECIES_CLAYDOL,
    .heldItem = ITEM_LIGHT_CLAY,
    .moves = {MOVE_EARTH_POWER, MOVE_ANCIENT_POWER, MOVE_LIGHT_SCREEN, MOVE_REFLECT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 63,
    .species = SPECIES_BRONZONG,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_STEEL_BEAM, MOVE_CHARGE_BEAM, MOVE_PROTECT, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 64,
    .species = SPECIES_MUSHARNA,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_MOONBLAST, MOVE_HYPNOSIS, MOVE_PROTECT, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 64,
    .species = SPECIES_BEHEEYEM,
    .heldItem = ITEM_WISE_GLASSES,
    .moves = {MOVE_METEOR_BEAM, MOVE_SIGNAL_BEAM, MOVE_PSYSHOCK, MOVE_NASTY_PLOT}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    ...
    .moves = {MOVE_PSYSHOCK, MOVE_PSYCHIC_TERRAIN, MOVE_DARK_PULSE, MOVE_TRICK_ROOM}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    .species = SPECIES_REUNICLUS,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_THUNDER, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMon sParty_Juan2[] = {
    ...
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_DAMP_ROCK,
    .moves = {MOVE_SURF, MOVE_LEECH_SEED, MOVE_GIGA_DRAIN, MOVE_RAIN_DANCE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 64,
    ...
    .moves = {MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_DRAGON_DANCE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 65,
    ...
    .species = SPECIES_JELLICENT,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_WILL_O_WISP, MOVE_HEX, MOVE_ACID_ARMOR, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 66,
    .species = SPECIES_MILOTIC,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_MOONBLAST, MOVE_SURF, MOVE_TOXIC, MOVE_RECOVER}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 68,
    .species = SPECIES_KINGDRA,
    .heldItem = ITEM_LIFE_ORB,
    .moves = {MOVE_DRACO_METEOR, MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_RAIN_DANCE}
    }
};
